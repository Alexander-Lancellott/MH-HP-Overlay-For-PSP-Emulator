...
GAME_MAP = {
    "ULES00318": {"name": "MHF"},  # EU
    "ULUS10084": {"name": "MHF"},  # US
    "ULES00851": {"name": "MHF2"},  # EU
    "ULUS10266": {"name": "MHF2"},  # US
    "ULES01213": {"name": "MHFU"},  # EU
    "ULUS10391": {"name": "MHFU"},  # US
...
def current_game(win_title: str):
    for game_id, info in GAME_MAP.items():
        if game_id in win_title:
            info["id"] = game_id
            return info
    return None
